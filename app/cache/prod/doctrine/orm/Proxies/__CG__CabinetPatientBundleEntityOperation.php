 ...
 */
class Operation extends \Cabinet\PatientBundle\Entity\Operation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setDoit($doit);
    }

    public function getDoit()
    {
        $this->__load();
        return parent::getDoit();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'type', 'doit', 'recu', 'fiche');
    }
